...
import com.example.holidaytest4.adapter.ViewPointAdapter;
import com.example.holidaytest4.beans.AreaWeatherInfo;
import com.example.holidaytest4.beans.ViewPointInfo;
import com.example.holidaytest4.comparators.WeatherComparator;
...
public class ViewPointActivity extends AppCompatActivity implements ItemClickListener {
    ...
    private void getDates_AH() {
        ...
        areaWeatherInfo1.setName("中国科学技术大学_今日");
        areaWeatherInfo1.setTemperature(Double.parseDouble(preferences.getString("temperature_ah_zkd", "")));
        areaWeatherInfo1.setHumidity(Double.parseDouble(preferences.getString("humidity_ah_zkd", "")));
        areaWeatherInfo1.setVisibility(Double.parseDouble(preferences.getString("visibility_ah_zkd", "")));
        areaWeatherInfo1.setRainfull(Integer.parseInt(preferences.getString("rainfall_ah_zkd", "")));

        AreaWeatherInfo areaWeatherInfo2 = new AreaWeatherInfo();
        areaWeatherInfo2.setName("颍上一中_今日");
        areaWeatherInfo2.setTemperature(Double.parseDouble(preferences.getString("temperature_ah_ys", "")));
        areaWeatherInfo2.setHumidity(Double.parseDouble(preferences.getString("humidity_ah_ys", "")));
        areaWeatherInfo2.setVisibility(Double.parseDouble(preferences.getString("visibility_ah_ys", "")));
        areaWeatherInfo2.setRainfull(Integer.parseInt(preferences.getString("rainfall_ah_ys", "")));

        AreaWeatherInfo areaWeatherInfo3 = new AreaWeatherInfo();
        areaWeatherInfo3.setName("九华山_今日");
        areaWeatherInfo3.setTemperature(Double.parseDouble(preferences.getString("temperature_ah_jhs", "")));
        areaWeatherInfo3.setHumidity(Double.parseDouble(preferences.getString("humidity_ah_jhs", "")));
        areaWeatherInfo3.setVisibility(Double.parseDouble(preferences.getString("visibility_ah_jhs", "")));
        areaWeatherInfo3.setRainfull(Integer.parseInt(preferences.getString("rainfall_ah_jhs", "")));

        AreaWeatherInfo areaWeatherInfo4 = new AreaWeatherInfo();
        areaWeatherInfo4.setName("黄山_今日");
        areaWeatherInfo4.setTemperature(Double.parseDouble(preferences.getString("temperature_ah_hs", "")));
        areaWeatherInfo4.setHumidity(Double.parseDouble(preferences.getString("humidity_ah_hs", "")));
        areaWeatherInfo4.setVisibility(Double.parseDouble(preferences.getString("visibility_ah_hs", "")));
        areaWeatherInfo4.setRainfull(Integer.parseInt(preferences.getString("rainfall_ah_hs", "")));

        //重庆 明日
        AreaWeatherInfo areaWeatherInfo5 = new AreaWeatherInfo();
        areaWeatherInfo5.setName("中国科学技术大学_明日");
        areaWeatherInfo5.setTemperature(Double.parseDouble(preferences.getString("temperature_ah_zkd_t", "")));
        areaWeatherInfo5.setHumidity(Double.parseDouble(preferences.getString("humidity_ah_zkd_t", "")));
        areaWeatherInfo5.setVisibility(Double.parseDouble(preferences.getString("visibility_ah_zkd_t", "")));
        areaWeatherInfo5.setRainfull(Integer.parseInt(preferences.getString("rainfall_ah_zkd_t", "")));

        AreaWeatherInfo areaWeatherInfo6 = new AreaWeatherInfo();
        areaWeatherInfo6.setName("颍上一中_明日");
        areaWeatherInfo6.setTemperature(Double.parseDouble(preferences.getString("temperature_ah_ys_t", "")));
        areaWeatherInfo6.setHumidity(Double.parseDouble(preferences.getString("humidity_ah_ys_t", "")));
        areaWeatherInfo6.setVisibility(Double.parseDouble(preferences.getString("visibility_ah_ys_t", "")));
        areaWeatherInfo6.setRainfull(Integer.parseInt(preferences.getString("rainfall_ah_ys_t", "")));

        AreaWeatherInfo areaWeatherInfo7 = new AreaWeatherInfo();
        areaWeatherInfo7.setName("九华山_明日");
        areaWeatherInfo7.setTemperature(Double.parseDouble(preferences.getString("temperature_ah_jhs_t", "")));
        areaWeatherInfo7.setHumidity(Double.parseDouble(preferences.getString("humidity_ah_jhs_t", "")));
        areaWeatherInfo7.setVisibility(Double.parseDouble(preferences.getString("visibility_ah_jhs_t", "")));
        areaWeatherInfo7.setRainfull(Integer.parseInt(preferences.getString("rainfall_ah_jhs_t", "")));

        AreaWeatherInfo areaWeatherInfo8 = new AreaWeatherInfo();
        areaWeatherInfo8.setName("黄山_明日");
        areaWeatherInfo8.setTemperature(Double.parseDouble(preferences.getString("temperature_ah_hs_t", "")));
        areaWeatherInfo8.setHumidity(Double.parseDouble(preferences.getString("humidity_ah_hs_t", "")));
        areaWeatherInfo8.setVisibility(Double.parseDouble(preferences.getString("visibility_ah_hs_t", "")));
        areaWeatherInfo8.setRainfull(Integer.parseInt(preferences.getString("rainfall_ah_hs_t", "")));
    ...
    public void onItemClick(int i) {
        switch (list.get(i).getName()) {
            //安徽
            case "中国科学技术大学":
                toDestination(31.836854,117.269603);
                break;
            case "颍上一中":
                toDestination(32.653207,116.264852);
                break;
            case "九华山":
                toDestination(30.478804,117.823956);
                break;
            case "黄山":
                toDestination(30.132266,118.169168);
                break;
            //重庆
            case "磁器口古镇":
